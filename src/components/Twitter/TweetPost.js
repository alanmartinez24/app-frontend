...
const styles = theme => ({
  article: {
    ...
    boxShadow: `20px 20px 30px 0px ${theme.palette.MONO.100}04, -2px -2px 30px  ${theme.palette.MONO.900}06, inset 12px 3px 30px 0px ${theme.palette.MONO.100}04, inset -3px -7px 27px 0px ${theme.palette.MONO.800}4a, 5px 5px 19px 0px ${theme.palette.MONO.100}24, -20px -20px 22px ${theme.palette.MONO.900}06, inset 1px 1px 16px 0px ${theme.palette.MONO.100}05, inset -1px -1px 12px 0px ${theme.palette.MONO.800}0f`,
